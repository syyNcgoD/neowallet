...
function GlobeDemoComponent() {
  return (
    <div className="relative flex h-full w-full items-center justify-center overflow-hidden bg-black pointer-events-none select-none">
...
export default memo(GlobeDemoComponent);
